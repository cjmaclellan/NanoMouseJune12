...
def deltapModeling(**kwargs):
  ...
  getpot.SetIniValue( "thermal_conductivity/k_0_tumor", kwargs['cv']['k_0_tumor'] ) 
  ...
  #
  femMesh.SetupUnStructuredGrid( "/data/cjmaclellan/mdacc/NanoMouseJune12/sphereMesh.e",0,RotationMatrix, Translation  )
...
try:
   ...
   continuous_vars['mu_s_healthy'] = "31000"
   continuous_vars['mu_s_tumor'] = "31000"
